...
<div id="primary" class="content-area">
    ...
    <?php  
        $New = new WP_Query( array( 'post_type' => 'face_of', 'posts_per_page' =>8) ); 
        $i=1;
        while ( $New->have_posts() ) : $New->the_post(); ?>
    ...
    <?php  
        $New = new WP_Query( array( 'post_type' => 'common_images', 'posts_per_page' =>8) ); 
        $i=1;
        while ( $New->have_posts() ) : $New->the_post(); ?>
    
    <?php 
        $thumbsValue = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'common_images' );
    ?> 
