...
<div id="primary" class="content-area">
    ...
    <?php  
        $New = new WP_Query( array( 'post_type' => 'image_grid1', 'posts_per_page' =>3) ); 
        $i=1;
        while ( $New->have_posts() ) : $New->the_post(); ?>
    ...
    <?php  
        $New = new WP_Query( array( 'post_type' => 'image_grid2', 'posts_per_page' =>1) ); 
        $i=1;
        while ( $New->have_posts() ) : $New->the_post(); ?>
    
    <?php 
        $thumbs_grid2 = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'image_grid2' );
    ?>
    ...
    <?php  
        $New = new WP_Query( array( 'post_type' => 'image_grid3', 'posts_per_page' =>3) ); 
        $i=1;
        while ( $New->have_posts() ) : $New->the_post(); ?>
    ...
    <?php  
        $New = new WP_Query( array( 'post_type' => 'what_we_do', 'posts_per_page' =>6) ); 
        $i=1;
        while ( $New->have_posts() ) : $New->the_post(); ?>
    ...
    <?php  
        $New = new WP_Query( array( 'post_type' => 'new_case_study', 'posts_per_page' =>1) ); 
        $i=1;
        while ( $New->have_posts() ) : $New->the_post(); ?>
    
    <?php 
        $newCase = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'new_case_study' );
      ?>             <div class="grid">                  
