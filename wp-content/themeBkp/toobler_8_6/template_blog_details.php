            ...
            <div class="blog-tittle">
                ...
                <div class="author-block">
                    ...
                    <div class="info">
                        ...
                        <div class="blog-date">
                           <?php echo html_entity_decode(get_field('blog_author_date')); ?>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    foreach ( $myposts1 as $post ) : setup_postdata( $post ); ?>
                        <li>
                            ...
                            <div class="stories-list">
                                <a href="#"><?php echo html_entity_decode(get_field('blog_head_text')); ?> </a>
                                <p><?php echo html_entity_decode(get_field('blog_author_name')); ?></p>
                            </div>
                        </li>
