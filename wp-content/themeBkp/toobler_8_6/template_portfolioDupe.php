...
<section class="testimonial-wrapper">
        ...
        <?php  
              $client_wrapper = new WP_Query( array( 'post_type' => 'portfolio_main', 'meta_key'=>'custom_category','meta_value'  => 'client_wrapper','posts_per_page' =>10) ); 
              $i=1;
              while ( $client_wrapper->have_posts() ) : $client_wrapper->the_post();   
              $client_wrapperImg = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'portfolio_main' );
        ?>


                   <div class="gallery-columns-5">
                       <figure>
                           <img src="<?php echo $client_wrapperImg['0']; ?>">    
                       </figure>
                   </div>
        <?php $i++; endwhile;  ?>
