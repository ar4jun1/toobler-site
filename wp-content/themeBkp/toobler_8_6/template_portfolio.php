        ...
        <?php $i++; endwhile;  ?>       
                ...
                <div class="test-video-details">
                    <div class="client-details">
                        <figure>
                            <img src="<?php echo get_stylesheet_directory_uri() ?>/img/testimonials/aron.png" alt="">
                        </figure>
                    ...
                    <div class="video-item-wrap owl-carousel">                                       
                       <div class="video-item" id="aronSmith">
                        ...
                        <div class="video-item" id="williamWillLopez">
                            <figure>
                                <img src="<?php echo get_stylesheet_directory_uri() ?>/img/testimonials/william-will-lopez.png" alt="">
                            </figure>                       
                        </div>
                        <div class="video-item" id="danielBox">
                            <span class="caret"></span>
                            <figure>
                                <img src="<?php echo get_stylesheet_directory_uri() ?>/img/testimonials/daniel.png" alt="">
                            </figure>
                        </div>
                         <div class="video-item" id="leeBarrett">
                            <figure>
                                <img src="<?php echo get_stylesheet_directory_uri() ?>/img/testimonials/lee.png" alt="">
                            </figure>
                        </div>
            ...
            <div class="layout-container">
               <div class="gallery-item">
                  <div class="gallery-columns-5">
                   ...
                   <div class="gallery-columns-5">
                       <figure>
                           <img src="<?php echo get_stylesheet_directory_uri() ?>/img/clients/advisorfi.png">    
                       </figure>
                   </div>
