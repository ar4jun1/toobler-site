        ...
        <?php $author_id=$post->post_author; ?>
            ...
            <div class="blog-tittle">
                ...
                <div class="author-block">
                    ...
                    <div class="info">
                        <div class="name">
                            <small>By</small><a href="#"><?php the_author_meta( 'display_name' , $author_id ); ?> </a>
                        </div>
                        <div class="blog-date">
        ...
        <div class="blog-main-wrapper">
            <div class="latest-stories">
                ...
                <ul class="stories-block">
                 ...
                 <?php 
                 $catId[] = get_cat_ID('blogOg');
                 $catId[] = get_cat_ID('beinspiredMain');
                 $catId[] = get_cat_ID('beinspiredMainSec');
                    $args1 = array( 'posts_per_page' => 3,'post__not_in'=>array($post->ID), 'category__in' => $catId );
